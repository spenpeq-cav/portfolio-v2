...
function ProfileSection() {
  return (
    <div className="w-full h-screen bg-top-image-6 bg-fixed bg-no-repeat bg-cover bg-center">
      <div className="bg-black bg-opacity-80 m-0 p-0 h-full w-full">
        <div className="max-w-md mx-auto md:max-w-3xl md:py-36 px-4 py-24">
          <img
